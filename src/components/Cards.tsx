...
const Cards: FC<questionPropTypes> = (props) => {
  ...
  const { questions, options, handleSubmit, questionNumber, totalQuestions } = props;
  ...
  return (
    <div className="cards">
      <div className="center">
        <h3 className="question-heading center">Question: {questionNumber + 1}/{totalQuestions}</h3>
      </div>
      <p>Q{questionNumber + 1}: {questions}</p>
